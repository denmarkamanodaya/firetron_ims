...
*/
	...
	Route::post('/products/build-process/',				['uses' => 'Core\ProductsController@build',		'as' => 'products.build']); //mimic product create from components but with return pop message
	//{service_type}/{product_code}/{quantity}
